...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 inline-flex items-center gap-2 rounded-full bg-accent-foreground px-4 py-3 text-sm font-semibold text-primary-foreground shadow-xl transition-transform hover:scale-105"
    >
